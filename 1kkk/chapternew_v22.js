    ...
    $(".chapterpager").find("a").each(function () {
        $(this).click(function () {
            if (DM5_REFRESH) {
                ...
                SetReadHistory(DM5_CID, DM5_MID, DM5_PAGE, DM5_USERID);		//dish 可以暂时不管
                getimage();
                SetFace();
                SetUrl();
                return false;
...
function SetReadHistory(cid, mid, p, uid) {
    if (!nosethistory)		//dish 一开始为false
    {
        if (DM5_USERID > 0) {
            var firsturl = $.cookie('firsturl');
            if (firsturl != null && firsturl != '') {
    ...
    ajaxobject = $.ajax({
        ...
        success: function (msg) {
            if (msg != '') {
                ...
                eval(msg);
				//dish 相当于执行了这一段
				//dish 执行完这一段后，d有两个元素，分别是两个url
//http://manhua1023-61-174-50-98.cdndm5.com/1/675/7889/95_5585.jpg?cid=7889&key=68082186c0bb91397aaee4db9be6f7dc&uk=
//http://manhua1023-61-174-50-98.cdndm5.com/1/675/7889/96_9889.png?cid=7889&key=68082186c0bb91397aaee4db9be6f7dc&uk=
				/*
...
'l 5(){2 8=4;2 6=\'9\';2 7="g://h-j-k-b-a.c.f/1/e/4";2 3=["/m.r","/s.t"];o(2 i=0;i<3.q;i++){3[i]=7+3[i]+\'?8=4&6=9&p=\'}n 3}2 d;d=5();',	//p

30,		//a

30,		//c

'||var|pvalue|7889|dm5imagefun|key|pix|cid|68082186c0bb91397aaee4db9be6f7dc|98|50|cdndm5||675|com|http|manhua1023||61|174|function|95_5585|return|for|uk|length|jpg|96_9889|png'.split('|'),		//k
